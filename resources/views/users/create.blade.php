...
<div class="mx-auto max-w-[1200px] px-4 sm:px-6 lg:px-8 py-16">
    <div class="mx-auto max-w-md">
        <h1 class="font-display text-[32px] leading-[1.25] tracking-[-0.8px] font-normal text-[#0c0a09] text-center">
            Tambah <span class="hl">user</span>
        </h1>
        <p class="mt-2 text-[14px] text-[#78716c] text-center">Buat akun baru beserta rolenya.</p>
        ...
        <div class="mt-8 rounded-[10px] border border-[#e8e6e5] bg-white p-6 shadow-[rgba(0,0,0,0.05)_0px_4px_16px_0px]">
            <form method="POST" action="{{ route('users.store') }}" class="flex flex-col gap-4">
                ...
                <div class="flex gap-2">
                    <button type="submit" class="rounded-full bg-[#3ba6f1] border border-[#3398e1] px-4 py-2 text-[14px] font-medium text-white hover:brightness-95">Simpan</button>
